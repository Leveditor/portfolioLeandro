...
const technologies = [
    ...
    { name: 'Controle de versão', icon: 'devicon-git-plain colored text-icons', githubIcon: 'devicon-github-original colored text-icons pl-5'},
    ...
    { name: 'Sistema operacional', icon: 'devicon-windows8-original colored text-icons', iconLinux: 'devicon-linux-plain colored text-icons pl-5'},
